...
public class UpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Mengambil referensi ke elemen EditText, ImageView, dan Button dari tata letak menggunakan ID-nya
        ...
        // Membaca data dari database berdasarkan kode yang diterima
        ...
        if (cursor.moveToFirst()) {
            ...
            // Mengatur nilai teks untuk elemen EditText dan ImageView
            ...
            // Menambahkan listener onClick untuk tombol Update
            ...
            // Menambahkan listener onClick untuk  back
    ...
    private void setUpdateData() {
        SQLiteDatabase ReadData = MyDatabase.getReadableDatabase();
            ...
            //Untuk Menentukan Data/Item yang ingin diubah, berdasarkan id
    ...
    // Mengimplementasikan metode onActivityResult untuk menangani hasil dari aktivitas pemilihan dan pemangkasan gambar
    @Override
    ...
    // Mengimplementasikan metode startCrop untuk memulai aktivitas pemangkasan gambar
